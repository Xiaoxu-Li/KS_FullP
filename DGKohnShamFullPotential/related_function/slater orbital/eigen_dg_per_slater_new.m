...
% eigen_solve_dg_slater solve the eigenvalue problem with periodic potential 
...
%
% using slater orbital as radial basis functions
% Apr 7th, 2018
...
% t=(cputime-t0)/60;
% fprintf('time=%d min\n',t);
% save dg_slater L R n0 N_p n_r Lm c nrm kk volum_omega delta
return;
